...
FindApproximateValuesThatWillMaximiseDValue <- function(predictionListStats, experimentalDataStats) {
    ...
    # Inputs: predictionListStats A vector containing the values q+, q- and q0 (the number of positive/negative/non-significant (or contradictory)
    # predictions) experimentalResultStats A vector containing the values n+, n- and n0 (the number of positive/negative/non-significant (or
    # contradictory) transcripts in the results)
