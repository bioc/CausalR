...
#Test 2
# The type of interaction column should either contain the entry "Activates" or "Inhibits"
 for (counter in 1:dim(dataTable)[1]){
    if (!((dataTable[[2]][counter] == "Activates")||(dataTable[[2]][counter] == "Activation")||(dataTable[[2]][counter] == "Inhibits")||(dataTable[[2]][counter] == "Inhibition"))){
