...
GetScoresWeightsMatrixByCubicAlg <- function(predictionListStats, experimentalDataStats, epsilon){
  ...
  # For each combination of row and column sum values, the value of n++ is bounded by zero and q+ (predictionListStats[1]).
  # Hence the maximum number of entries in distributionMatrix will be:
