...
GetApproximateMaximumDValueFromThreeByTwoContingencyTable <- function(threeByTwoContingencyTable, predictionListStats, 
                                                                    logOfFactorialOfPredictionListStats, returnlog = FALSE){			        
# *** Summary ***
# Description: A function that will compute an approximate maximum D value (or weight) for a superfamily (3x2 table).
