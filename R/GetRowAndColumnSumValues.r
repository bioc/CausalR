...
GetRowAndColumnSumValues <- function(predictionListStats, experimentalResultStats) {
    ...
    # Pre-declare an array to store the valid column/row sum values - since we only iterate over three quantities, the array can have a maximum size
    # equal to the product of the three smallest values out of q_p+1, q_m+1, n_p+1, and n_m+1.
