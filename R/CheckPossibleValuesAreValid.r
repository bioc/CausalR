...
CheckPossibleValuesAreValid <- function(predictionDataStats, experimentalDataStats, possibleValues) {
    ...
    # The conditions that need to be fulfilled are a series of inequalities The conditions will be number so that they can matched to the test function
    # Condition 1
    ...
    # n_zp (n0p) is the number of genes predicted to have a non-significant interaction with the hypothesis but are actually in the positively affected
    # in the results
    ...
    # n_zm (n0m) is the number of genes predicted to have a non-significant interaction with the hypothesis but are actually in the negatively affected
    # in the results
