...
ProcessExperimentalData <- function(experimentalData, network){
  ...
  # A matrix of zeros that will ultimately store the experimental data results as
  # an array containing purely doubles
  ...
  # If any of the node names aren't in the network, output a warning message
  # and delete those rows from the table.
