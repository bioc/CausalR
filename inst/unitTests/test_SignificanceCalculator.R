...
test_GetWeightForNumbersOfCorrectandIncorrectPredictionsProducesCorrectOutputWhenReturnLogIsFalse <- function() {
    ...
    checkEquals(CausalR:::GetWeightForNumbersOfCorrectandIncorrectPredictions(1, 0, 1, 1, c(3, 2, 0), c(2, 1, 2), logOfFactorialOfPredictionListStats, 
        returnlog = FALSE), 6)
    checkEquals(CausalR:::GetWeightForNumbersOfCorrectandIncorrectPredictions(2, 1, 0, 0, c(3, 2, 0), c(2, 1, 2), logOfFactorialOfPredictionListStats, 
        returnlog = FALSE), 3)
}
...
test_GetWeightForNumbersOfCorrectandIncorrectPredictionsProducesCorrectOutputWhenReturnLogIsTrue <- function() {
    logOfFactorialOfPredictionListStats <- c(log(factorial(3)), log(factorial(2)), log(factorial(0)))
    checkEquals(CausalR:::GetWeightForNumbersOfCorrectandIncorrectPredictions(1, 0, 1, 1, c(3, 2, 0), c(2, 1, 2), logOfFactorialOfPredictionListStats, 
        returnlog = TRUE), log(6))
    checkEquals(CausalR:::GetWeightForNumbersOfCorrectandIncorrectPredictions(2, 1, 0, 0, c(3, 2, 0), c(2, 1, 2), logOfFactorialOfPredictionListStats, 
        returnlog = TRUE), log(3))
}
...
test_CalculateSignificanceCallsCalculateSignificanceUsingCubicAlgorithm <- function() {
    ...
    pValue_direct <- CausalR::CalculateSignificanceUsingCubicAlgorithm(5, c(7, 4, 9), c(6, 6, 8), 1e-05)
    pValue_indirect <- CausalR:::CalculateSignificance(5, c(7, 4, 9), c(6, 6, 8), 1e-05, TRUE)
...
test_CalculateSignificanceCallsCalculateSignificanceUsingQuarticAlgorithm <- function() {
    ...
    pValue_direct <- CausalR::CalculateSignificanceUsingQuarticAlgorithm(5, c(7, 4, 9), c(6, 6, 8))
